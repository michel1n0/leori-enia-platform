...
public class RejectAIInitiativeUseCase {
    ...
    public VersionedAIInitiativeDetails execute(RejectAIInitiativeCommand command) {
        Objects.requireNonNull(
                command,
                "Reject AI initiative command is required"
        );
        Objects.requireNonNull(command.initiativeId(), "AI initiative id is required");
        ...
        try {
            initiative.reject(command.reason(), occurredAt);
